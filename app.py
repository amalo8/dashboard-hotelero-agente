...
@st.cache_data
def cargar_datos():
    df_info = pd.read_csv('datos/procesados/df_hoteles_vlc_info.csv', encoding='latin-1')
    df_comentarios = pd.read_csv('datos/procesados/df_comentarios_final_topics.csv', encoding='latin-1')
